...
<head>
    ...
    <link rel="stylesheet" href="leaveTracker.css">
                  ...
                  <div class="card">
                    <div class="card-body" style="background-color: #E5E6F0; border-color: #E5E6F0; box-shadow: none;">
                        ...
                        <div style="display:flex; margin: 30px auto 0 auto;">
                            <div style="margin: 0 auto 0 2%;"><p style="color: #111;">Casual Leave (12/09/22)&#8594</p></div>
                            <div style="margin: 0 2% 0 auto;"><p style=" color: green;">Accepted</p></div>
                        </div>
                        <div style="display:flex; margin-top: 8px auto 25px auto;">
                            <div style="margin: 0 auto 0 2%;"><p style="color: #111;">Casual Leave (23/07/22)&#8594</p></div>
                            <div style="margin: 0 2% 0 auto;"><p style=" color: red;">Denied</p></div>
                        </div>
                    </div>
                  </div>
                </div>

...
<body>
    ...
    <script type="text/javascript">
        ...
        // function submitForm() {
        //     let lt = document.querySelector("#leaveType").value;
        ...
        //     let inc = document.querySelector("#incharge").value;
        //     document.cookie = "lt = " + lt;
        //     document.cookie = "sd = " + sd;
        //     document.cookie = "ed = " + ed;
        //     document.cookie = "sub = " + sub;
        //     document.cookie = "txt = " + txt;
        //     document.cookie = "inc = " + inc;
        //     @php
        //         $lt= $_COOKIE['lt'];
        //         $sd= $_COOKIE['sd'];
        //         $ed= $_COOKIE['ed'];

        ...
        <div id="content">
            ...
            <div class="row" style="margin-top: 30px;">
                ...
                @if ($user->designation == 'Dean')
                    ...
                    @if($singleuser->faculty == $user->faculty && $singleuser->designation != 'Dean')
                        <div class="col-sm-4">
                        ...
                        <div id="myModal" class="modal">
                            ...
                            <h5>{{ $singleuser->name }}</h5>
                            <p style="text-align:center;">{{ $singleuser->designation }}</p>
                    ...
                    @endif
                @else
                    @if($singleuser->department == $user->department && $singleuser->designation != 'Chairman' && $singleuser->designation != 'Dean')
                        <div class="col-sm-4">
                            <div class="card user-div" onclick="showDetails()">
                                <div class="card-body user-content">
                                    <div class="user-pic"><i class="fas fa-user-alt"></i></div>
